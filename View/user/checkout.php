...
<div class="heading">
   <h3>checkout</h3>
   <p><a href="../webpage/home.php">home</a> <span> / checkout</span></p>
</div>
...
<form action="" method="post">
   ...
   <div class="cart-items">
      ...
      <a href="../../Model/product/cart.php" class="btn">veiw cart</a>
   </div>
   ...
   <div class="user-info">
      ...
      <a href="../user/update_profile2.php" class="btn">update info</a>
      ...
      <a href="../user/update_address.php" class="btn">update address</a>
