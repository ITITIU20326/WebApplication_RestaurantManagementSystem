...
if(isset($_POST['update_payment'])){
   ...
   $delivery_status = $_POST['delivery_status']; // New field
   $update_status = $conn->prepare("UPDATE `orders` SET payment_status = ?, delivery_status = ? WHERE id = ?");
   $update_status->execute([$payment_status, $delivery_status, $order_id]);
